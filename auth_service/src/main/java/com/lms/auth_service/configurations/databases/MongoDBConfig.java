...
@Configuration
@EnableMongoRepositories(basePackages = "com.lms.auth_service.repositories.nosql")
public class MongoDBConfig {
    ...
    public org.springframework.data.mongodb.core.MongoTemplate mongoTemplate() {
        return new org.springframework.data.mongodb.core.MongoTemplate(mongoClient(), "lms_auth");
    }
}
